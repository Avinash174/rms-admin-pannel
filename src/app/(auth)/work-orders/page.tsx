...
export default function WorkOrdersPage() {
  ...
  return (
    <div className="space-y-6 p-6">
      <PageHeaderCard
        title="Work Orders Master"
        description="Create & track operational work orders for Pickups, Returns, Transfer & Destruction"
        badge="Operations & Logistics · Work Orders"
        icon={Sliders}
      >
        ...
        <button onClick={() => setIsOpen(true)} className="px-4 py-2 bg-violet-600 hover:bg-violet-500 text-white rounded-xl text-xs font-semibold flex items-center gap-1.5 shadow-md transition">
